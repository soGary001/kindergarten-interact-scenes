...
const livingRoom: ConfigScene = {
  ...
  locations: [
    { id: "table",      labelEn: "table",      preposition: "on",    anchor: { xPct: 38, yPct: 66 } },
    { id: "tv-cabinet", labelEn: "TV cabinet", preposition: "on",    anchor: { xPct: 11, yPct: 56 } },
    { id: "chair",      labelEn: "chair",      preposition: "on",    anchor: { xPct: 27, yPct: 53 } },
    { id: "sofa",       labelEn: "sofa",       preposition: "on",    anchor: { xPct: 65, yPct: 55 } },
    { id: "windowsill", labelEn: "windowsill", preposition: "on",    anchor: { xPct: 42, yPct: 26 } },
    { id: "desk-lamp",  labelEn: "lamp",       preposition: "by",    anchor: { xPct: 61, yPct: 44 } },
    { id: "carpet",     labelEn: "carpet",     preposition: "on",    anchor: { xPct: 41, yPct: 80 } },
    { id: "wardrobe",   labelEn: "wardrobe",   preposition: "in",    anchor: { xPct: 82, yPct: 47 } },
    { id: "bookshelf",  labelEn: "bookshelf",  preposition: "on",    anchor: { xPct: 90, yPct: 55 } },
    { id: "pillow",     labelEn: "pillow",     preposition: "under", anchor: { xPct: 55, yPct: 55 } },
  ],
};
...
const boyScene: ConfigScene = {
  ...
  locations: [
    { id: "door",       labelEn: "door",       preposition: "by", anchor: { xPct: 29, yPct: 63 } },
    { id: "grass",      labelEn: "grass",      preposition: "on", anchor: { xPct: 50, yPct: 60 } },
    { id: "shelf",      labelEn: "shelf",      preposition: "on", anchor: { xPct: 14, yPct: 22 } },
    { id: "chair",      labelEn: "chair",      preposition: "on", anchor: { xPct: 16, yPct: 54 } },
    { id: "sofa",       labelEn: "sofa",       preposition: "on", anchor: { xPct: 82, yPct: 60 } },
    { id: "windowsill", labelEn: "windowsill", preposition: "on", anchor: { xPct: 81, yPct: 37 } },
    { id: "carpet",     labelEn: "carpet",     preposition: "on", anchor: { xPct: 46, yPct: 85 } },
  ],
};
...
const girlScene: ConfigScene = {
  ...
  locations: [
    { id: "station", labelEn: "station", preposition: "at", anchor: { xPct: 11, yPct: 56 } },
    { id: "park",    labelEn: "park",    preposition: "in", anchor: { xPct: 32, yPct: 64 } },
    { id: "garden",  labelEn: "garden",  preposition: "in", anchor: { xPct: 58, yPct: 60 } },
    { id: "balcony", labelEn: "balcony", preposition: "on", anchor: { xPct: 88, yPct: 28 } },
    { id: "shelf",   labelEn: "shelf",   preposition: "on", anchor: { xPct: 87, yPct: 42 } },
    { id: "carpet",  labelEn: "carpet",  preposition: "on", anchor: { xPct: 75, yPct: 83 } },
  ],
};
